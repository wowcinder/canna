...
import xdata.etl.testweb.server.util.BeanFinder;
import xdata.etl.testweb.server.util.ClassScaner;
...
public class SpringMVCGwtRpcProxyUtil implements
	...
	protected void initPathToClass() {
		try {
			ClassScaner scaner = new ClassScaner("xdata.etl.testweb.client");
