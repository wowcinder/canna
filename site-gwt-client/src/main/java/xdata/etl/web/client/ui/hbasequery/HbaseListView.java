...
public class HbaseListView extends BorderLayoutContainer implements
		CenterView {
				...
				Scheduler.get().scheduleDeferred(new ScheduledCommand() {
					...
					public void execute() {
						ServiceUtil.HbaseTableRpcCaller
								.get(new GwtCallBack<List<HbaseTable>>() {
									@Override
									protected void _call(List<HbaseTable> t) {
	...
	private void showTable(String tableName) {
		HbaseQueryView tab = new HbaseQueryView(tableName);
